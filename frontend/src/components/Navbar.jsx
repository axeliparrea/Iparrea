    ...
    <nav className="navbar navbar-expand-lg fixed-top py-2" style={navbarStyle}>
      <div className="container-fluid px-4">
        ...
        <Link className="navbar-brand py-1" to="/" style={{ color: colors.text }}>
          ...
          />
          <span className="ms-3 fw-bold d-none d-md-inline" style={{ 
          ...
          <span className="ms-3 fw-bold d-md-none" style={{ 
            color: colors.primary,
            fontFamily: 'monospace',
            fontSize: '16px'
          }}>
        ...
        <div className={`collapse navbar-collapse ${isMenuOpen ? 'show' : ''}`}>
          ...
          <ul className="navbar-nav mx-auto mb-0 d-flex gap-2 justify-content-center">
          ...
          <div className="d-flex align-items-center gap-2 flex-wrap justify-content-center justify-content-lg-end">
            {/* Theme Toggle */}
            <button 
              onClick={toggleTheme}
